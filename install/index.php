...
if($_POST["pass"] != $_POST["pass2"])
	  ...
	  mysql_query("CREATE TABLE IF NOT EXISTS wronnay_news (
      ...
      PRIMARY KEY (id) );
      ");
	  mysql_query("CREATE TABLE IF NOT EXISTS wronnay_news_comments (
      id INT(22) NOT NULL auto_increment,
      ...
      PRIMARY KEY (id) );
      ");
	  mysql_query("CREATE TABLE IF NOT EXISTS wronnay_forum_smilies (
      id INT(22) NOT NULL auto_increment,
